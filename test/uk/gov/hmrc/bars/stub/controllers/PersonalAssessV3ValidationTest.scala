...
class PersonalAssessV3ValidationTest extends AnyFunSuite {
  ...
  test("personal address with no lines throws exception") {
    ...
    val fakeRequest = FakeRequest(method = "POST", path = s"/verify/personal")
      .withHeaders(DEFAULT_TEST_HEADER)
      .withJsonBody(Json.toJson(PersonalRequest(accountDetails, subject)))
  ...
  test("personal address with too many lines throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
  ...
  test("personal address with empty lines throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
  ...
  test("personal address with lines that total more than 140 chars throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
  ...
  test("personal address with blank town throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
  ...
  test("personal address with no town throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
  ...
  test("personal address with town that is too long throws exception") {
    val accountDetails = AccountDetails("207106", "87236342")
    val subject = Subject(
      name = Some("Maya Jackson"),
      address = Some(Address(
