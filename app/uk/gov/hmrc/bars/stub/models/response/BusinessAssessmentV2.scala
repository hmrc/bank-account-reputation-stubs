...
case class BusinessAssessmentV2(accountNumberWithSortCodeIsValid: String,
...
object BusinessAssessmentV2 {
  implicit val writes: OFormat[BusinessAssessmentV2] = Json.format[BusinessAssessmentV2]

  implicit val reads: Reads[BusinessAssessmentV2] = Json.reads[BusinessAssessmentV2]
}
