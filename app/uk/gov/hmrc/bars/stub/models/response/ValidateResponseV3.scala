...
case class ValidateResponseV3(accountNumberIsWellFormatted: String,
...
object ValidateResponseV3 {
  implicit val writes: OFormat[ValidateResponseV3] = Json.format[ValidateResponseV3]

  implicit val reads: Reads[ValidateResponseV3] = Json.reads[ValidateResponseV3]
}
