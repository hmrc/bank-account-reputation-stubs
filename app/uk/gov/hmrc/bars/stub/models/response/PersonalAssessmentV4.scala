...
case class PersonalAssessmentV4(accountNumberIsWellFormatted: String,
...
object PersonalAssessmentV4 {
  implicit val writes: OFormat[PersonalAssessmentV4] = Json.format[PersonalAssessmentV4]

  implicit val reads: Reads[PersonalAssessmentV4] = Json.reads[PersonalAssessmentV4]
}
